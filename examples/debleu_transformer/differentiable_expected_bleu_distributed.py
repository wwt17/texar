...
flags.DEFINE_string("config_dist", "config_dist", "The distributed config.")
...
def main():
    """Entrypoint.
    """
    cluster = tf.train.ClusterSpec(config_dist.cluster)
