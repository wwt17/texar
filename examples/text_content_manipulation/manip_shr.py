...
def build_model(data_batch, data):
    ...
    def build_align():
        ...
        # TODO: to concatenate the embeddings, we should pad them to the
        # same length  
        ...
        attention_score = tf_outputs.attention_score
        ...
        for sd_field in used_sd_fields:
            ...
            _logits = tf.reshape(
                _projection(tf.contrib.layers.flatten(tf_outputs)),
                tf.concat([ori_shape[:-1], [vocab.size])
